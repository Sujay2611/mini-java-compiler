...
Variable_declaration:Type Expr '=' Expr Operators Expr Identifier_list';' {if(((strcmp($5.addr,"+") || strcmp($5.addr,"-")) && strcmp($6.addr,"0")) ||  ((strcmp($5.addr,"*") || strcmp($5.addr,"/")) && strcmp($6.addr,"1"))){append(l,$4.addr,$2.addr);$$.code = (char*)malloc(sizeof(char)*100); sprintf($$.code,"%s = %s\n",$2.addr,$4.addr);fprintf(fp,"%s",$$.code);} else {append(l,$4.addr,$2.addr);$$.code = (char*)malloc(sizeof(char)*100); sprintf($$.code,"%s = %s %s %s\n",$2.addr,$4.addr,$5.addr,$6.addr);fprintf(fp,"%s",$$.code);}}; |Type Expr Identifier_list';';
...
Expression:Expr |Expr Operators Expression ;
